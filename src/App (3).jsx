  ...
  return (
    <div style={{minHeight:"100vh",background:P.bgVoid,color:P.textoP,fontFamily:F.display}}>
      ...
      <header style={{position:"sticky",top:0,zIndex:200,background:"rgba(5,8,10,0.97)",backdropFilter:"blur(16px)",borderBottom:`1px solid ${P.borda}`}}>
        <div style={{background:`${P.esmeralda}0c`,borderBottom:`1px solid ${P.borda}`,padding:"6px 16px",fontSize:11,fontFamily:F.body,color:P.textoS,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div style={{overflow:"hidden",whiteSpace:"nowrap",flex:1}}>
            <span style={{color:P.rubi,fontWeight:700,marginRight:11}}>● AO VIVO</span>
            {tickerM&&<><span style={{marginRight:9}}>{tickerM.emoji} {tickerM.q.slice(0,45)}…</span><span style={{color:P.esmeralda,fontWeight:700}}>SIM {pct(tickerM.sim,tickerM.nao)}%</span><span style={{color:P.textoS,margin:"0 11px"}}>·</span><span style={{color:P.ouro}}>{fmt(tickerM.sim+tickerM.nao)} pts</span></>}
          </div>
          <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",flexShrink:0,marginLeft:16,borderLeft:`1px solid ${P.borda}`,paddingLeft:12}}>
            <span style={{fontSize:14,fontWeight:800,color:P.esmeralda,fontFamily:F.mono,letterSpacing:1.5,lineHeight:1}}>
              {relogio.toLocaleTimeString("pt",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}
            </span>
            <span style={{fontSize:8.5,color:P.textoS,fontFamily:F.body,letterSpacing:.5,marginTop:1}}>
              {relogio.toLocaleDateString("pt",{weekday:"short",day:"numeric",month:"short"}).toUpperCase()} · MAPUTO
            </span>
          </div>
        </div>
        <div style={{maxWidth:980,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",height:60,padding:"0 18px"}}>
          ...
          <div style={{display:"flex",gap:5,alignItems:"center"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",marginLeft:8,borderLeft:`1px solid ${P.borda}`,paddingLeft:12}}>
              <span style={{fontSize:15,fontWeight:800,color:P.esmeralda,fontFamily:F.mono,letterSpacing:1,lineHeight:1}}>
                {relogio.toLocaleTimeString("pt",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}
              </span>
              <span style={{fontSize:9,color:P.textoS,fontFamily:F.body,letterSpacing:.5}}>
                {relogio.toLocaleDateString("pt",{weekday:"short",day:"numeric",month:"short"}).toUpperCase()}
              </span>
            </div>
